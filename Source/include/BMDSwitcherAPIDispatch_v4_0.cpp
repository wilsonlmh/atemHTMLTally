...
** -LICENSE-END-
*/
/* BMDSwitcherAPIDispatch_v4_0.cpp */
...
typedef IBMDSwitcherDiscovery_v4_0* (*CreateDiscoveryFunc)(void);
...
static void	InitBMDSwitcherAPI_v4_0 (void)
{
	CFURLRef		bundleURL;
...
{
	pthread_once(&gBMDSwitcherOnceControl, InitBMDSwitcherAPI_v4_0);
